...
PM_dir=/users/pliang/afs/Ceb/examples/${data}/PM/${exp}
gtpath=/users/pliang/afs/Ceb/examples/${data}/GT/${exp}
...
exp=test
PM_dir_test=/users/pliang/afs/Ceb/examples/${data}/PM/${exp}
gtpath_test=/users/pliang/afs/Ceb/examples/${data}/GT/${exp}
